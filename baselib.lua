-- Xeno Executor UI Library v3 (Animated & Dark Theme)
local Xeno = {}
...
-- Обновленная, более темная и богатая цветовая палитра
local Colors = {
    Background = Color3.fromRGB(15, 15, 15),     -- Более темный фон
    Section = Color3.fromRGB(22, 22, 22),        -- Фон элементов
    Hover = Color3.fromRGB(32, 32, 32),          -- Цвет при наведении
    Click = Color3.fromRGB(45, 45, 45),          -- Цвет при клике
    Accent = Color3.fromRGB(65, 130, 220),       -- Красивый синий акцент
...
function Xeno:CreateWindow(config)
    ...
    local NotifContainer = Create("Frame", {
        Parent = XenoGui, Size = UDim2.new(0, 250, 1, -20), Position = UDim2.new(1, -270, 0, 10),
        BackgroundTransparency = 1, ZIndex = 100
    })
    Create("UIListLayout", {Parent = NotifContainer, SortOrder = Enum.SortOrder.LayoutOrder, Padding = UDim.new(0, 10), VerticalAlignment = Enum.VerticalAlignment.Bottom})
    ...
    function Xeno:Notify(opts)
        ...
        local NotifFrame = Create("Frame", {
            Parent = NotifContainer, Size = UDim2.new(1, 50, 0, 60), BackgroundColor3 = Colors.Section, BackgroundTransparency = 1
        })
    ...
    local CloseBtn = Create("TextButton", {
        ...
        BackgroundTransparency = 1, Text = "✕", TextColor3 = Colors.TextDark, TextSize = 16, Font = Enum.Font.GothamMedium
    })
    ...
    local MinBtn = Create("TextButton", {
        ...
        BackgroundTransparency = 1, Text = "−", TextColor3 = Colors.TextDark, TextSize = 22, Font = Enum.Font.GothamMedium
    })
    ...
    -- Tooltip System (улучшенный)
    local TooltipGui = Create("Frame", {
        Parent = XenoGui, Size = UDim2.new(0, 200, 0, 30), BackgroundColor3 = Colors.Background,
    ...
    Create("UIPadding", {Parent = TooltipGui, PaddingLeft = UDim.new(0, 8), PaddingRight = UDim.new(0, 8), PaddingTop = UDim.new(0, 5), PaddingBottom = UDim.new(0, 5)})
    ...
    RunService.RenderStepped:Connect(function()
        ...
        if isHovering then
            ...
            elseif tick() - hoverStart >= 1.5 then -- Уменьшил задержку тултипа до 1.5 сек
    ...
    Create("UIStroke", {Parent = PromptBox, Color = Colors.Accent, Thickness = 1})
    ...
    local BtnNo = Create("TextButton", { Parent = PromptBox, Size = UDim2.new(0.4, 0, 0, 35), Position = UDim2.new(0.55, 0, 1, -45), BackgroundColor3 = Colors.Section, Text = "Нет", TextColor3 = Colors.Text, Font = Enum.Font.GothamBold, ZIndex = 52, BackgroundTransparency = 1, TextTransparency = 1 })
    ...
    function windowObj:Prompt(text, callback)
        ...
        PromptBox.Position = UDim2.new(0.5, -150, 0.5, -50) -- Старт анимации
        
        Tween(PromptOverlay, {BackgroundTransparency = 0.6})
        Tween(PromptBox, {BackgroundTransparency = 0, Position = UDim2.new(0.5, -150, 0.5, -75)})
        ...
        local function closePrompt(res)
            ...
            Tween(PromptOverlay, {BackgroundTransparency = 1})
            Tween(PromptBox, {BackgroundTransparency = 1, Position = UDim2.new(0.5, -150, 0.5, -50)})
    ...
    function windowObj:CreateTab(name, iconId)
        ...
        TabBtn.MouseButton1Click:Connect(function()
            for _, t in pairs(Tabs) do
                ...
                Tween(t.Btn, {TextColor3 = Colors.TextDark})
        ...
        function tabObj:CreateButton(opts)
            ...
            local Label = Create("TextLabel", { Parent = BtnFrame, Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1, Text = "  " .. opts.Name, TextColor3 = Colors.Text, Font = Enum.Font.GothamMedium, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left })
        ...
        function tabObj:CreateToggle(opts)
            ...
            local Label = Create("TextLabel", { Parent = TogFrame, Size = UDim2.new(1, -40, 1, 0), Position = UDim2.new(0, 10, 0, 0), BackgroundTransparency = 1, Text = opts.Name, TextColor3 = Colors.Text, Font = Enum.Font.GothamMedium, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left })
            ...
            local Stroke = Create("UIStroke", {Parent = CheckBox, Color = state and Colors.Accent or Colors.TextDark, Thickness = 1})
            ...
            local CheckIcon = Create("ImageLabel", {
                ...
                ImageTransparency = state and 0 or 1, ImageColor3 = Colors.Background
            })
        ...
        function tabObj:CreateSlider(opts)
            ...
            local Label = Create("TextLabel", { Parent = SldFrame, Size = UDim2.new(1, -20, 0, 20), Position = UDim2.new(0, 10, 0, 5), BackgroundTransparency = 1, Text = opts.Name, TextColor3 = Colors.Text, Font = Enum.Font.GothamMedium, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left })
        ...
        function tabObj:CreateKeybind(opts)
            ...
            local Label = Create("TextLabel", { Parent = BindFrame, Size = UDim2.new(1, -100, 1, 0), Position = UDim2.new(0, 10, 0, 0), BackgroundTransparency = 1, Text = opts.Name, TextColor3 = Colors.Text, Font = Enum.Font.GothamMedium, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left })
            ...
            BindBtn.MouseButton1Click:Connect(function()
                binding = true
                BindBtn.Text = "..."
                Tween(BindBtn, {BackgroundColor3 = Colors.Click}, 0.1)
            end)
            ...
            UserInputService.InputBegan:Connect(function(input, gp)
                if binding and input.UserInputType == Enum.UserInputType.Keyboard then
                    ...
                    Tween(BindBtn, {BackgroundColor3 = Colors.Background}, 0.1)
        ...
        -- НОВОЕ: Color Picker (RGB Слайдеры)
        function tabObj:CreateColorPicker(opts)
            ...
            Create("UIStroke", {Parent = ColorPreview, Color = Colors.TextDark, Thickness = 1})
            ...
            local function CreateRGBRow(name, yPos, colorRGB, initVal)
                ...
                local Lbl = Create("TextLabel", { Parent = Row, Size = UDim2.new(0, 20, 1, 0), Position = UDim2.new(0, 10, 0, 0), BackgroundTransparency = 1, Text = name, TextColor3 = colorRGB, Font = Enum.Font.GothamBold, TextSize = 14 })
            ...
            local function UpdateColors()
                ...
                Tween(ColorPreview, {BackgroundColor3 = color}, 0.1)
            ...
            MainBtn.MouseButton1Click:Connect(function()
                expanded = not expanded
                Tween(PickerFrame, {Size = UDim2.new(1, 0, 0, expanded and 130 or 35)}, 0.25)
            end)
        end
